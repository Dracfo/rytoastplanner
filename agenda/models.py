...
class Meeting(models.Model):
    ...
    guestlist = models.CharField(max_length=256, default=None, null=True)
...
class Rolelist(models.Model):
    ...
    facilitator = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="facilitator", null=True)
    zoom = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="zoom", null=True)
    toastmaster = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="toastmaster", null=True)
    geneval = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="geneval", null=True)
    saa = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="saa", null=True)
    chair = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="chair", null=True)

    speaker1 = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="speaker1", null=True)
    speaker2 = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="speaker2", null=True)
    speaker3 = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="speaker3", null=True)
    eval1 = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="eval1", null=True)
    eval2 = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="eval2", null=True)
    eval3 = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="eval3", null=True)

    ttmaster = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="ttmaster", null=True)
    tteval = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="tteval", null=True)

    timer = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="timer", null=True)
    ah_counter = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="ah_counter", null=True)
    quizmaster = models.ForeignKey("User", on_delete=models.SET_NULL, related_name="quizmaster", null=True)
