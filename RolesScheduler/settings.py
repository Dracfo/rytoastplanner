"""
Django settings for RolesScheduler project.
...
ROOT_URLCONF = 'RolesScheduler.urls'
...
WSGI_APPLICATION = 'RolesScheduler.wsgi.application'
...
EMAIL_FILE_PATH = 'django-email-dev'
